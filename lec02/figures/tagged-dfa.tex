...
\node[rectangular state,accepting] (two) [above right of=one] { \scriptsize\itshape 2:\textsc{ident} };
\node[rectangular state,accepting] (three) [right of=two] { \scriptsize\itshape 3:\textsc{if} };
\node[rectangular state,accepting] (four) [below right of=one] { \scriptsize\itshape 4:\textit{skip} };
\node[rectangular state,accepting] (five) [right of=one] { \scriptsize\itshape 5:\textsc{ident} };
