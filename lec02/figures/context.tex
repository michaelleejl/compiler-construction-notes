\begin{tikzpicture}
\node[draw,darkred,rounded corners,anchor=north east,minimum height=0.1\textheight,fill=linkcolor] (lexing)
 at (0, 0) { \textcolor{white}{\scriptsize \textbf{\textsf{lexing}}} };

\node[draw,darkred,rounded corners,anchor=west,minimum height=0.1\textheight] (parsing) at ($(lexing.east) + (0.5cm,0)$)
{ \textsf{\scriptsize parsing }};

\node[draw,darkred,rounded corners,anchor=west,minimum height=0.1\textheight] (typechecking) at ($(parsing.east) + (0.5cm,0)$)
...
\node[draw,darkred,rounded corners,anchor=west,minimum height=0.1\textheight] (middle) at ($(tree.east) + (0.4cm,0)$) { \textsf{\tiny middle/back end} };
