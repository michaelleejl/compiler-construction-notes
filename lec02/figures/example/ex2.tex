...
\node[rectangular state,accepting,fill opacity=0.15,text opacity=1.0,fill=linkcolor] (two) [above right of=one] { \scriptsize\itshape 2:\textsc{ident} };
\node[rectangular state,accepting,fill opacity=0.15,text opacity=1.0,fill=white] (three) [right of=two] { \scriptsize\itshape 3:\textsc{if} };
...
% \node<3,4>[fill=darkred,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (0.4,0) { };
% \node<5,6>[fill=darkred,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (0.6,0) { };
% \node<7>[fill=darkred,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (0.8,0) { };
% \node<8>[fill=darkred,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (1.0,0) { };
...
% \draw<3-4>[thick,->,darkred] (0.4,-0.5) -- +(0,0.5); % if
% \draw<5-6>[thick,->,darkred] (0.6,-0.5) -- +(0,0.5); % skip
% \draw<7>[thick,->,darkred] (0.8,-0.5) -- +(0,0.5); % i
% \draw<8>[thick,->,darkred] (1.0,-0.5) -- +(0,0.5); % if
% \draw<9>[thick,->,darkred] (1.2,-0.5) -- +(0,0.5); % ifx


\node[anchor=north] at (0.2,-0.5) { \scriptsize \textsc{ident} };
% \node<3-4>[anchor=north] at (0.4,-0.5) { \scriptsize \textsc{if} };
% \node<7>[anchor=north] at (0.8,-0.5) { \scriptsize \textsc{ident} };
% \node<8>[anchor=north] at (1.0,-0.5) { \scriptsize \textsc{if} };
% \node<9>[anchor=north] at (1.2,-0.5) { \scriptsize \textsc{ident} };

\node at (0.0,-1.0) { }; % spacing
\node[anchor=west] at (tokens.east) { \footnotesize\color{darkest}\textsc{[]} };
% \node<4-9>[anchor=west] at (tokens.east) { \footnotesize\color{darkest}\textsc{if} };
