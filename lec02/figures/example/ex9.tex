...
\node[rectangular state,accepting,fill opacity=0.15,text opacity=1.0,fill=linkcolor] (five) [right of=one] { \scriptsize\itshape 5:\textsc{ident} };
...
\node[fill=linkcolor,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (1.2,0) { };
...
\draw[thick,->,darkred] (1.2,-0.5) -- +(0,0.5); % ifx
...
\node[anchor=north] at (1.2,-0.5) { \scriptsize \textsc{ident} };
