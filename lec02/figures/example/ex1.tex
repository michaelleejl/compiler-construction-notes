...
\node[initial,rectangular state,fill opacity=0.15,text opacity=1.0,fill=linkcolor] (one) { \scriptsize\itshape 1 };
...
% \node<2>[fill=darkred,fill opacity=0.2,minimum width=0.48cm,minimum height=0.48cm,anchor=south west] at (0.2,0) { };
...
% \draw<2>[thick,->,darkred] (0.2,-0.5) -- +(0,0.5); % i
