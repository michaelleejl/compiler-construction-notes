...
Adding these transitions into the DFA, we realise we have added no new states, so we must be done.

\begin{center}
    \import{figures/derivatives}{lex-with-deriv-3}
\end{center}

Derivatives thus give us a way of directly creating tagged DFAs.
