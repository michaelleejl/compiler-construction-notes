...
\algblockdefx[ON]{On}{EndOn}[1]{\textbf{on} #1 \textbf{do}}{\textbf{end on}}
\algblockdefx[TRANSACTION]{Transaction}{EndTransaction}{\textbf{transaction}}{\textbf{end transaction}}
