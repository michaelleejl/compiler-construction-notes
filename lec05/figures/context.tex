...
\node[draw,darkred,rounded corners,anchor=west,minimum height=0.1\textheight, fill=linkcolor] (parsing) at ($(lexing.east) + (0.5cm,0)$)
{ \textcolor{white}{\textbf{\textsf{\scriptsize parsing}}}};
