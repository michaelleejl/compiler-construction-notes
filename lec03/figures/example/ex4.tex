...
\node[draw,minimum height=16ex,minimum width=4ex,text opacity=1.0, fill=highlight, fill opacity = 0.1] (stack) at ($(q3) + (38ex,6.5ex)$) { };
...
$\begin{array}{l}
\langle q_2, bbb, \textsc{sssz} \rangle
