...
\node[state,initial,fill opacity=0.1,fill=highlight,text opacity=1.0] (q1) [right of=q0]{ q$_1$ };
\node[state,fill opacity=0.1,fill=white,text opacity=1.0] (q2) [right of=q1]{ q$_2$ };
...
\draw[draw opacity=0.0,fill=highlight,fill opacity=0.1] (0,0) rectangle (1.2,0.4);
...
\node[draw,minimum height=4ex,minimum width=4ex,text opacity=1.0, fill=highlight, fill opacity = 0.1] (stack) at ($(q3) + (38ex,0.6ex)$) { };
...
$\begin{array}{l}
\langle q_1, aaabbb, \textsc{z} \rangle \\[0.1ex]
% \only<2>{\color{highlight}}  \langle q_1, aabbb, \textsc{sz} \rangle \\[0.1ex]
% \only<3>{\color{highlight}}  \langle q_1, abbb, \textsc{ssz} \rangle \\[0.1ex]
% \only<4>{\color{highlight}}  \langle q_2, bbb, \textsc{sssz} \rangle \\[0.1ex]
% \only<5>{\color{highlight}}  \langle q_2, bb, \textsc{ssz} \rangle \\[0.1ex]
