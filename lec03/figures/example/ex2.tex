...
\draw[draw opacity=0.0,fill=highlight,fill opacity=0.1] (0.2,0) rectangle (1.2,0.4);
...
\node[draw,minimum height=8ex,minimum width=4ex,text opacity=1.0, fill=highlight, fill opacity = 0.1] (stack) at ($(q3) + (38ex,2.5ex)$) { };
...
$\begin{array}{l}
\langle q_1, aabbb, \textsc{sz} \rangle
